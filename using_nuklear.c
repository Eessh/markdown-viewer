...
int main(int argc, char* argv[])
{
  ...
  /* Load Cursor: if you uncomment cursor loading please hide the cursor */
  {
    ...
    /* if(!font) */
    /* { */
    /*   log_fatal("Unable to load default font."); */
    /*   exit(-1); */
    /* } */
...
#  elif defined(STYLE_RED)
  ...
  log_info("Setting RED theme ...");
#  elif defined(STYLE_BLUE)
  set_style(ctx, THEME_BLUE);
  log_info("Setting BLUE theme ...");
#  elif defined(STYLE_DARK)
  set_style(ctx, THEME_DARK);
  log_info("Setting DARK theme ...");
#  endif
#endif
  ...
  while(running)
  {
    ...
    if(SDL_WaitEvent(&evt))
    {
      ...
      {
        log_info("Encountered QUIT event.");
        goto cleanup;
      }
      if(evt.type == SDL_WINDOWEVENT &&
         evt.window.event == SDL_WINDOWEVENT_RESIZED)
      {
        log_info("Window resize: (%d, %d) -> (%d, %d)",
                 WINDOW_WIDTH,
                 WINDOW_HEIGHT,
                 evt.window.data1,
                 evt.window.data2);
    ...
    if(nk_begin(ctx, "Demo", nk_rect(0, 0, WINDOW_WIDTH, WINDOW_HEIGHT), 0))
    {
      ...
      /**/
      /* nk_layout_row_static(ctx, 5, WINDOW_WIDTH - 20, 1); */
      /* if(nk_button_label(ctx, "Button")) */
      /*   log_info("Button pressed."); */
      /* if(nk_button_label(ctx, "Hehe")) */
      /*   log_info("Hehe pressed."); */
      /* if(nk_button_label(ctx, "Boii")) */
      /*   log_info("Boii pressed."); */

      nk_layout_row_dynamic(ctx, ctx->style.font->height, 1);

      nk_labelf(ctx, NK_TEXT_ALIGN_LEFT, "Hehe Boii: %d", 2);
      nk_layout_row_dynamic(ctx, 50, 1);
      const char* text =
        "Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. ";
      float text_width = ctx->style.font->width(
        ctx->style.font->texture, (ctx->style.font->height), text, 60);
      log_debug("Text width: %f", text_width);
      nk_labelf_wrap(
        ctx,
        "Hehe Boii: %d, Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. "
        "Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. "
        "Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. "
        "Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. "
        "Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. Hehe Boii. "
      ...
      /*      ctx, nk_rgb_cf(bg), nk_vec2(nk_widget_width(ctx), 400))) */
      /* { */
...
/* -------------- EXAMPLES ---------------- */
    ...
    SDL_SetRenderDrawColor(
      renderer, bg.r * 255, bg.g * 255, bg.b * 255, bg.a * 255);
